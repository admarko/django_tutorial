...
def create_question(question_text: str, days: int) -> Question:
    """
    helper to create a Question with text and offset days (negative for past)
    """
...
class QuestionIndexViewTests(TestCase):
    def test_no_question(self):
        """
        If no question exists, display appropriate message
        """
    ...
    def test_past_question(self):
        """
        Question with a date in past are displayed on page
        """
